...
const Details = ({ fetchWeather, weather }) => {
	return (
		<div className='flex flex-col justify-evenly w-full bg-green-500 border-white-l sm:border-4 sm:w-4/5 sm:h-[95%] sm:rounded-3xl sm:shadow-2xl sm:m-auto lg:w-3/5 2xl:w-2/5 custom details'>
